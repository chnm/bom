...
monarchs = pd.read_excel("2023-04-30-monarchs-bill-transcriptions.xlsx", sheet_name="counts")
...
# Read the shapefile
parishes = gpd.read_file("../../../bom-data/parish-shapefiles/WithinTheBills1622/WithinTheBills1622.shp")
...
parishes.to_file("parishes-merged.shp", driver="ESRI Shapefile")