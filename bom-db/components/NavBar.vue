<template>
  ...
  <div class="w-full block flex-grow-0 lg:items-center lg:w-auto">    
    <div class="text-sm lg:flex-grow">
      ...
      <a href="https://deathbynumbers.org/data/" class="inline-block px-3 py-2 items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75 ml-2">
        Data
      </a>
    </div>
  </div>
